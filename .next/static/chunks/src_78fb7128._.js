...
function SearchPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SearchPage.useEffect": ()=>{
            ...
            const timeoutId = setTimeout({
                "SearchPage.useEffect.timeoutId": ()=>{
                    if (searchTerm) {
                        void handleSearch();
                    } else {
                        setResults([]);
            ...
            }["SearchPage.useEffect.timeoutId"], 300);
            return ({
                "SearchPage.useEffect": ()=>clearTimeout(timeoutId)
            })["SearchPage.useEffect"];
        }
    }["SearchPage.useEffect"], [
        searchTerm,
    ...
    const loadTopPosts = async ()=>{
        try {
            const { data: posts, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('posts').select('id, image_url, likes_count, comments_count').order('likes_count', {
                ascending: false
            }).limit(9);
            if (error) {
    ...
    const handleSearch = async ()=>{
        ...
        try {
            if (searchType === "users") {
                const { data: users, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('*').or(`username.ilike.%${searchTerm}%,full_name.ilike.%${searchTerm}%`).limit(20);
                if (error) throw error;
                setResults(users || []);
            } else if (searchType === "tags") {
                const { data: tags, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('tags').select('*').ilike('name', `%${searchTerm}%`).limit(20);
                if (error) throw error;
                setTagResults(tags || []);
            }
        } catch (error) {
...
_s(SearchPage, "63uRa3zpN0lMa/hZaMCAb8NkZIo=", false, function() {
    return [
...
//# sourceMappingURL=src_78fb7128._.js.map